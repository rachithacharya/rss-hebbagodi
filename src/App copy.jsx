...
const App = () => {
  ...
  const whatsappNumber = "8792235863";
...
Thank you.`,
  ...
  const vasatiData = [
    {
      id: 1,
      name: { kn: "ತಿರುಪಾಳ್ಯ ವಸತಿ", en: "Tirupali Vasati" },
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-3">
              <span className="flex items-center">
                <img src="./public/om.png" alt="RSS" className="w-10 h-10" />
              </span>
